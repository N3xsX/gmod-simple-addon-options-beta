            ...
            if optionData then
                ...
                for categoryName, categoryOptions in pairs(optionData.options) do
                    ...
                    for optionName, optionData in pairs(categoryOptions) do
                        ...
                        if optionData.conVar ~= nil and optionData.default ~= nil and not GetConVar(optionData.conVar) then
...
function Opmenu:PrintError(num, addonName, categoryName, categoryInfo, conVar, optionType)
    local errorMessages = {
        ...
        "[Simple Addon Options] Error 9: Max or Min value in " .. tostring(addonName) .. " => " .. tostring(optionType) .. " => " .. tostring(categoryName) .. " => " .. tostring(conVar) .. " is NIL!",
        ...
        "[Simple Addon Options] Error 12: Default value is NIL! " .. tostring(addonName) .. " => " .. tostring(optionType) .. " => " .. tostring(categoryName) .. " => " .. tostring(conVar),
    }
